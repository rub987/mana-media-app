...
export async function PUT(request: Request) {
  ...
  const { id, plateforme, type_campagne, objectif, budget_total, budget_journalier, date_debut, date_fin, statut, url_cible, notes } = body;
  ...
  await logActivity({
    ...
    action: "Campagne sociale modifiée",
    entity_type: "social",
    entity_id: id,
